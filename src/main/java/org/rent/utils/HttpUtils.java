...
//        CloseableHttpClient client = HttpClients.custom().setSSLSocketFactory(ssf).build();
     ...
     * @return json数据
     */
    private static String doGet(CloseableHttpClient client, String url, Map<String, Object> requestParam, String charset) {
     ...
     * @return json数据
     */
    private static String doPost(CloseableHttpClient client, String url, Map<String, Object> requestParam, String charset) {
        Charset defaultCharset = !StringUtils.isEmpty(charset) ? Charset.forName(charset) : UTF8;
        Assert.notNull(url, "url is null");
        ...
        logger.info("\nPOST请求 URL:{}, charset:{} \n 请求参数:{} 请求结果:\n{}", url, defaultCharset.toString(), requestParam, result);
        return result;
    }
